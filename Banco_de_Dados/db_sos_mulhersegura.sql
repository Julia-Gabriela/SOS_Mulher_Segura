...
ALTER TABLE Usuarios ADD COLUMN cep VARCHAR(9) NOT NULL;
ALTER TABLE Usuarios ADD COLUMN bairro VARCHAR(100) NOT NULL;
ALTER TABLE Usuarios ADD COLUMN numero VARCHAR(10) NOT NULL;
ALTER TABLE Usuarios ADD COLUMN complemento VARCHAR(100) DEFAULT NULL;
ALTER TABLE Usuarios CHANGE password senha VARCHAR(128) NOT NULL;
